...
const editAvatarButton = document.querySelector<HTMLButtonElement>(
...
const editAvatarForm = document.querySelector<HTMLFormElement>(
  "#edit-avatar-form",
)!;
const newCardForm =
...
const editAvatarPopup = new PopupWithForm(
  ...
  async (inputValues) => {
    ...
    try {
      const avatarData: AvatarFormData = { avatar: inputValues.avatar };
